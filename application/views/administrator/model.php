...
<div class="content-wrapper">
   ...
   <section class="content-header headermodel modeladdvenderpri ">
      <h1 class="brandpaddmodel">
         <i class="fa fa-users"></i> Model  Management
         <small></small>
         
<a href="<?php echo base_url();?>administrator/addmodel" class="add-clss btn btn-success addvenderpri modelmanageadvri">Add New Model</a></h1>
   </section>
								...
								foreach($Records as $record){ ?>
									<tr>
									 ...
									 <td class="avail-edit-delete-un">
									       ...
									       <a href="<?php echo base_url();?>administrator/editmodel/<?php echo $record->id;?>"  class="btn btn-success ">Edit</a> <a href="javascript:;" rel="<?php echo $record->id;?>" class="btn btn-danger delete-brand">Delete</a> 
									   </div></td>
									 </tr><?php
								}
                           } ?>
