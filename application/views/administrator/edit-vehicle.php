         ...
         <div class="col-md-12">
            ...
            <div class="row">
			    <?php if($this->session->flashdata('success')){  ?>
                        ...
                        <?php } ?>
               <h2 class="cardetai">Your Car Details</h2>
               <div class="col-md-6">
                  ...
                  <select name="advert_type" class="form-control" required='true'>
                     ...
                     <option value="sell" <?php if($Records['advert_type']=='sell'){echo "selected";}?>>For Sale</option>
                     <option value="rent" <?php if($Records['advert_type']=='rent'){echo "selected";}?>>For Rent</option>
                  </select>
               </div>
               <div class="col-md-6">
               ...
               <div class="col-md-6">
                  ...
                  <select name="transmission" class="form-control" required='true'>
                     ...
                     <option value="automatic" <?php if($Records['transmission']=='automatic'){echo "selected";}?>>Automatic</option>
			   ...
			   <div class="col-md-6">
					...
					<select name="guide_price" class="form-control">
						...
						<option value="Great Price" <?php if($Records['guideprice']=='Great Price'){echo "selected";}?>>Great Price</option>
						<option value="Good Price" <?php if($Records['guideprice']=='Good Price'){echo "selected";}?>>Good Price</option>
						<option value="Above Market" <?php if($Records['guideprice']=='Above Market'){echo "selected";}?>>Above Market</option>
					</select>
			   </div>
                  ...
                  <div class="tab-content" id="myTabContent2">
                     <div id="en-1" class="tab-pane fade in active">
                        ...
                        <div class="col-md-12">
                           ...
                           <textarea type="text" class="form-control" name="description" id="description" required="true"><?php if(!empty($Records['description'])){echo $Records['description'];}?></textarea>
                           <!--<textarea id="editor10" name="description" class="form-control" ></textarea>-->
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-6">
				...
				<div class="col-md-6">
					...
					<select name="post_status" class="form-control">
						...
						<option value="1" <?php if($Records['status']=='1'){echo "selected";}?>>Published</option>
						<option value="0" <?php if($Records['status']=='0'){echo "selected";}?>>UnPublished</option>
					</select>
			   </div>
