...
<section id="portfolio" class="advreslsection">
   <div class="page-heading-two Upeer-headers-section">
      <div class="container">
         <!--<div class="col-md-7">
            <h5 class="breads">Result</h5>
         </div>-->
   ...
   <div class="container">
      <div class="row ">
         <div class="advdirest">
            <div class="sidebar margnssides">
               <form role="form" action="<?php echo base_url();?>vehicle/advresults" method="post" id="search-form">
                  <div class="s-widget">
                     <h5 class="searchfillma">Search Filters</h5>
                     <br>                     <!-- Form Group -->                     
                     <div class="widget-content search">
                        <div class="col-md-2">
                        <div class="form-group serchadvvic">
                        ...
                        <?php if(!empty($postData['advert_type'])) {?>
                        ...
                        <div class="col-md-2 serchadvvic">
         ...
         <div class="col-md-12 paginationresultdevs">
              <div id='pagination1' class="text-center my-5 v-page"></div>
            <div class="blog-one" id='postsList'> </div>
