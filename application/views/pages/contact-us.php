...
<section id="portfolio" class="Upeer-headers-section formscontact">
   <div class="page-heading-two">
      <div class="container">
	  
         <div class="col-md-12">
            <h5 class="breads">Home <span>/ Contact</span></h5>
         </div>	
   ...
   <div class="container div_center">
      <div class="col-md-12 col-sm-12 col-xs-12">
         <form action="" method="post" role="form" novalidate="" class="form-horizontal "  id="contact-form">
            <div class="row">
			<h4 class="contacth">Contact Form</h4>
			<hr/>
			<div class="alert alert-success alert-dismissible" id="msg-contact-form" style="display:none;">
               ...
               <div class="col-md-6">
                  ...
                  <input id="fname" type="text" name="fname" placeholder="First Name" value="" class="form-control textname" required='true'>
                  
               </div>
			    <div class="col-md-6">
                  <label class="control-label">Last Name</label>                                
                  <input id="lname" type="text" name="lname" placeholder="Last Name" value="" class="form-control textname" required='true'>
                  
               </div>
               <div class="col-md-12">
                  <label class="control-label">Email</label>
                  <input id="email" type="email" name="email" placeholder="Email" value="" class="form-control textname"  required='true'>
                 
               </div>
               <div class="col-md-12">
                           <label class="control-label">Message</label> <textarea rows="5" name="message" class="form-control textname" ></textarea>
               </div>
            ...
            <div class="row">
               <div class="col-md-12 pt_40">
                  <div class="form-group" style="text-align:center">
					...
					<input type="submit" class="btn btn-white subwhitsectio" value="Submit" >
                  </div>
               </div>
            </div>
        </form>
