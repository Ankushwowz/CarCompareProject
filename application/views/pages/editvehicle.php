...
<section class="portfolio" id="portfolio">
      ...
      <div class="col-md-8">
                 ...
                 <form action="<?php echo base_url();?>editvehicle/<?php echo $this->uri->segment(2)?>" method="post" role="form" novalidate="" class="form-horizontal" enctype="multipart/form-data" id="edit_form_sell_a_car" >
            <div class="row">
           ...
           <div class="clearfix pt_40"></div>
            ...
            <div class="row">
               <div class="col-md-12 pt_40">
                  <div class="form-group c-btn" style="text-align:center">
					<input type="hidden" id="user_id" name="user_id" value="<?php 
						...
						<?php 
						if($this->session->userdata('role')==3){
						if(!empty($Records['package']) && $Records['package']=='basic'){
							if($Records['amount'] ==0){
							?>
							<a href="#" class="btn btn-success savepublish" rel="<?php echo $Records['id'] ?>">Save & Publish</a>
						<?php }
						...
						<!--<a href="<?php //echo base_url();?>preview/<?php echo $this->uri->segment(2)?>" class="btn btn-primary">Preview Advert</a>-->
						<input type="submit" class="btn btn-success sv-cg" value="Save Changes" name="updatevehicle">
