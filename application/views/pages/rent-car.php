...
<section id="portfolio" class="Upeer-headers-section">
   <div class="page-heading-two">
      <div class="container">
         ...
         <!--   <h5 class="car-title-detail">Rent Car</h5>-->
         <!--</div>-->
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="breads">
               <a href="<?php echo base_url();?>">Home</a> / Rent Car        
            </div>
         </div>
         ...
         <form role="form" action="<?php echo base_url();?>vehicle/advresults" method="post" id="search-form">
            <div class="row">
               <div class="col-md-12 col-sm-12">
                  <h3 class="usedfulsection">Rent Car</h3>
                  <hr class="hrmagr"/>
               </div>
               <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-group">
                     <label for="input-11">Advert Type</label>
                      <select name="selectadvert_type" id="advert_type" class="form-control advert-type filter-search filter-search-common" disabled>
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-group">
                     <label for="input-11">Condition</label>
                    	<select name="condition" id="condition" class="form-control car-condition filter-search filter-search-common">
