...
<section id="portfolio" class="Upeer-headers-section">
   <div class="page-heading-two">
      <div class="container">
         <!--<div class="col-md-7">-->
         <!--   <h5 class="car-title-detail">Used Car</h5>-->
         <!--</div>-->
         <div class="col-md-12">
            <div class="breads text-right">
               <a href="<?php echo base_url();?>">Home</a> / Used Car        
            </div>
         </div>
         ...
         <form role="form" action="<?php echo base_url();?>vehicle/advresults" method="post" id="search-form">
            <div class="row">
               <div class="col-md-12 col-sm-12">
                  <h3 class="usedfulsection">Used Car</h3>
                  <hr class="hrmagr"/>
               </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-group">
					...
					<!--<input type="hidden" name="advert_type" value="sell" >-->
                  </div>
               </div>
			   <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-group">
